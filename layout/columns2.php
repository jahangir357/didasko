...
if (isloggedin() && isset($PAGE->theme->settings->shownavclosed) && $PAGE->theme->settings->shownavclosed == 0) {
...
echo $OUTPUT->render_from_template('theme_didasko/columns2', $templatecontext);
