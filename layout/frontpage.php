...
$templatecontext = [
	...
	'img1' => $OUTPUT->image_url('images/img1', 'theme'),
...
if (isset($PAGE->theme->settings->showbacktotop) && $PAGE->theme->settings->showbacktotop == 1) {
    ...
    $PAGE->requires->js('/theme/didasko/javascript/scrolltotop.js');
}

//$PAGE->requires->js('/theme/didasko/javascript/scrolltotop.js');
$templatecontext['flatnavigation'] = $PAGE->flatnav;
echo $OUTPUT->render_from_template('theme_didasko/frontpage', $templatecontext);
