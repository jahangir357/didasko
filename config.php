...
$THEME->prescsscallback = 'theme_didasko_get_pre_scss';

// This is a function that returns some SCSS as a string to prepend to the main SCSS file.                                          
$THEME->extrascsscallback = 'theme_didasko_get_extra_scss';

// This is the function that returns the SCSS source for the main file in our theme. We override the boost version because          
// we want to allow presets uploaded to our own theme file area to be selected in the preset list.                                  
$THEME->scss = function($theme) {                                                                                                   
    return theme_didasko_get_main_scss_content($theme);                                                                               
};
...
$THEME->javascripts = array('scrolltotop');
$THEME->rendererfactory = 'theme_overridden_renderer_factory';
